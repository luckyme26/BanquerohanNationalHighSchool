...
<nav class="w3-sidebar w3-blue w3-collapse w3-top w3-large w3-animate-left" style="z-index:3;width:13em;font-weight:bold;" id="mySidebar"><br>
    ...
    <div class="w3-bar-block">
        <a href="<?php echo base_url();?>Student/dashboard/<?php echo $link;?>"  onclick="w3_close()" class="w3-bar-item w3-button w3-white w3-text-blue w3-hover-text-blue w3-hover-white w3-padding-16" style="border-radius: 30px 0px 0px 30px;">
            ...
            <div class="w3-col m9 w3-margin-bottom">
                <div class="w3-border">
                    <div class="w3-container">
                        ...
                        <?php
                            $this->Student_model->subj_overview($id, $link, $gradelvl);
                        ?>
                    </div>
                </div>
            </div>
                        ...
                        <div class="w3-row-padding">
                            ...
                            <div class="w3-col m7">
                                <div class="w3-round">
                                    ...
                                    <?php
                                      $this->Student_model->getEventsWithinMonth();
                                    ?>
...
<script type="text/javascript">
    ...
    function LoadAll(a) {
        ...
        setInterval(function(){
            ...
            countonlineusers.open("GET", "https://"+window.location.hostname+"/BanquerohanNationalHighSchool/Student/countOnline/"+x, true);
            ...
            onlinelist.open("POST", "https://"+window.location.hostname+"/BanquerohanNationalHighSchool/Student/OnlineList/"+x, true);
            onlinelist.send();
            //ONLINE USERS | END
            ...
            announcements.open("POST", "https://"+window.location.hostname+"/BanquerohanNationalHighSchool/Student/announcements/"+x, true);
            announcements.send();
            ...
            todo.open("POST", "https://"+window.location.hostname+"/BanquerohanNationalHighSchool/Student/todo/"+x, true);
            todo.send();
