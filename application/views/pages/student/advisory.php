...
<nav class="w3-sidebar w3-blue w3-collapse w3-top w3-large w3-animate-left" style="z-index:3;width:13em;font-weight:bold;" id="mySidebar"><br>
    ...
    <div class="w3-bar-block">
        ...
        <a href="<?php echo base_url();?>Student/advisory/<?php echo $link;?>" onclick="w3_close()" class="w3-bar-item w3-button w3-white w3-text-blue w3-hover-text-blue w3-hover-white w3-padding-16" style="border-radius: 30px 0px 0px 30px;">
            <span class="fa fa-user-circle-o w3-margin-left"></span>&nbsp;&nbsp;<?php echo $section; ?>
        </a>
...
<div class="w3-main" style="margin-left: 14.5em;">
    ...
    <div class="w3-container w3-white w3-hide-small w3-hide-medium" style="box-shadow: 2px 0px 5px 1px gray;">
        <span>
            <h3 class="w3-left w3-padding"><b><?php echo strtoupper($title);?></b></h3>
            <div class="w3-dropdown-click w3-right w3-margin-top">
                ...
                <div id="items" class="w3-dropdown-content w3-bar-block w3-border" style="right: 0; width: 30em; height:35em; overflow: scroll;z-index: 1"></div>
            </div>
        </span>
    </div>
    <!-- END OF HEADER -->
    ...
    <div class="w3-container">
        ...
        <h3><?php echo strtoupper($gradelvl).' - '.strtoupper($section); ?></h3>
            <div class="w3-container w3-border w3-margin-bottom">
                <h4>SUBJECT AND SUBJECT TEACHERS</h4>
                <?php
                    $this->Student_model->getClassAdvSubj($id, $link, $gradelvl, $section);
                ?>
            </div>
            ...
            <div class="w3-container w3-border w3-margin-bottom">
                <h4>STUDENTS</h4>
                <?php
                    $this->Student_model->getClassAdv($id, $link, $gradelvl, $section);
                ?>
            </div>
        </div>
    </div>
