...
<nav class="w3-sidebar w3-blue w3-collapse w3-top w3-large w3-animate-left" style="z-index:3;width:13em;font-weight:bold;" id="mySidebar"><br>
    ...
    <div class="w3-bar-block">
        ...
        <a href="<?php echo base_url();?>Student/grading/<?php echo $link.'/'.$grade;?>" onclick="w3_close()" class="w3-bar-item w3-button w3-text-white w3-hover-text-blue w3-hover-white w3-padding-16" style="border-radius: 30px 0px 0px 30px;">
...
<div class="w3-main" style="margin-left: 14.5em;">
    ...
    <div class="w3-container">
        ...
        <div class="w3-container w3-border w3-padding w3-margin-bottom">
            <a href="<?php echo base_url(); ?>Student/subjects/overview/<?php echo $link; ?>" class="w3-small w3-text-blue" style="text-decoration: none;">Subjects</a> / <a href="<?php echo base_url(); ?>Student/subjects/<?php echo $subj_code; ?>/<?php echo $link; ?>" class="w3-small w3-text-blue" style="text-decoration: none;"><?php echo $subj; ?></a> / <span class="w3-small"><?php echo $title; ?></span>
            <h3><b><?php echo strtoupper($title);?></b></h3>

            <?php
                echo '<div class="w3-container">';
                    $this->Student_model->getQuizContent($link, $subj_code, $title, $grade, $section, $lesson, $subj, $id);
                echo '</div>';
            ?>
        </div>
    </div>
