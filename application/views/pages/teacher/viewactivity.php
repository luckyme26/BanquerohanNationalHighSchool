...
<div class="w3-main" style="margin-left: 14.5em;">
    ...
    <div class="w3-container">
        ...
        <div class="w3-container w3-border w3-padding w3-margin-bottom">
            <a href="<?php echo base_url(); ?>Teacher/subjects/overview/<?php echo $link; ?>" class="w3-small w3-text-blue" style="text-decoration: none;">Subjects</a> / <a href="<?php echo base_url(); ?>Teacher/subjects/<?php echo $subj_code; ?>/<?php echo $link; ?>" class="w3-small w3-text-blue" style="text-decoration: none;"><?php echo $subj; ?></a> / <span class="w3-small"><?php echo str_replace("_", ",", $title); ?></span>
            <h3><b><?php echo strtoupper(str_replace("_", ",", $title));?></b></h3>

            <?php
                echo '<div class="w3-container">';
                    $this->Teachers_model->getActivityContent($link, $subj_code, $title, $grade, $section, $lesson, $subj);
                echo '</div>';
            ?>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function functionSearchName(){
        var input, filter, table, tr, td, i, j;
        input = document.getElementById("Studname");
