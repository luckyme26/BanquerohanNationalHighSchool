...
<nav class="w3-sidebar w3-blue w3-collapse w3-top w3-large w3-animate-left" style="z-index:3;width:13em;font-weight:bold;" id="mySidebar"><br>
    ...
    <div class="w3-bar-block">
        ...
        <a href="<?php echo base_url();?>Teacher/concerns/<?php echo $link;?>" onclick="w3_close()" class="w3-bar-item w3-button w3-white w3-text-blue w3-hover-text-blue w3-hover-white w3-padding-16" style="border-radius: 30px 0px 0px 30px;">
        ...
        <div class="w3-modal" id="postconcern">
            <div class="w3-modal-content w3-animate-top">
                ...
                <div class="w3-container w3-padding-large">
                    <form action="<?php echo base_url()?>Teacher/postconcern/<?php echo $link; ?>" method="post" class="w3-padding">
        ...
        <div class="w3-container w3-border w3-padding w3-margin-bottom">
            ...
            <?php if($this->session->flashdata('success')){;?>
                <p class="w3-panel w3-pale-green w3-center">
                    <?php echo $this->session->flashdata('success'); header("Refresh:1;url = ".base_url()."Teacher/concerns/".$link);?>
                </p>
            <?php };?>
            <?php if($this->session->flashdata('error')){;?>
                <p class="w3-panel w3-pale-red w3-center">
                    <?php echo $this->session->flashdata('error'); header("Refresh:1;url = ".base_url()."Teacher/concerns/".$link);?>
                </p>
            <?php }; ?>
            ...
            <?php
                //$this->Teachers_model->postedconcerns($link);
            ?>
...
<script type="text/javascript">
    ...
    function LoadAll(a) {
        ...
        setInterval(function(){
            ...
            concernssent.open("POST", "https://"+window.location.hostname+"/BanquerohanNationalHighSchool/Teacher/concernssent/"+x, true);
            concernssent.send();
            ...
            concernspending.open("POST", "https://"+window.location.hostname+"/BanquerohanNationalHighSchool/Teacher/concernspending/"+x, true);
            ...
            concernsdeclined.open("POST", "https://"+window.location.hostname+"/BanquerohanNationalHighSchool/Teacher/concernsdeclined/"+x, true);
            ...
            concernsresolved.open("POST", "https://"+window.location.hostname+"/BanquerohanNationalHighSchool/Teacher/concernsresolved/"+x, true);
