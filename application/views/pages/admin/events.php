 	...
 	<div class="w3-container">
  	...
  	<div class="w3-bar-block">  
	    ...
	    <div id="others_items" class="w3-container w3-show">
	    	...
	    	<a href="<?php echo base_url();?>admin/events" onclick="w3_close()" class="w3-bar-item w3-button w3-white w3-text-blue w3-hover-text-blue w3-hover-white w3-padding w3-small w3-margin-left" style="border-radius: 30px 0px 0px 30px;">
...
<div class="w3-main w3-animate-right w3-margin-bottom" style="margin-left: 245px;">
  	...
  	<div class="w3-container w3-white w3-hide-small w3-hide-medium" style="box-shadow: 2px 0px 5px 1px gray;">
	    <span>
	    	<h3 class="w3-left w3-padding"><b>EVENTS</b></h3>
	    	<div class="w3-dropdown-click w3-right w3-margin-top">
  	...
  	<div class="w3-container">
	    ...
	    <button onclick="document.getElementById('create').style.display='block'" class="w3-button w3-round w3-blue w3-hover-light-blue w3-hover-text-white"><span class="fa fa-pencil-square-o"></span>&nbsp;&nbsp;Create event</button>
	    
	    <!-- Flashdata -->
	    <?php if($this->session->flashdata('uploaded')){;?>
	    <p class="w3-panel w3-pale-green w3-center w3-padding">
	        <?php echo $this->session->flashdata('uploaded'); header("Refresh:2;url=events");?>
	    </p>
		<?php };?>
		<?php if($this->session->flashdata('error')){;?>
	    <div class="w3-panel w3-pale-red w3-center w3-padding">
	        <?php echo $this->session->flashdata('error'); header("Refresh:2;url=events");?>
	    </div>
		<?php };?>
		<!-- END Flashdata -->
	    ...
	    <div class="w3-row-padding w3-margin-top">
	    	<div class="w3-card w3-round w3-padding">
	    		<h5><b>EVENTS THIS MONTH</b></h5>

	    		<?php 
				   $this->users_model->EventsThisMonth();
	    		?>
	    	</div>
	    </div>
	    ...
	    <div class="w3-row-padding w3-margin-top">
	    	<div class="w3-card w3-round w3-padding">
	    		...
	    		<?php 
				   $this->users_model->allevents();	//retrieving all created events
	    		?>
	    	</div>
	    </div>
	    <!-- | END OF FIRST ROW | -->
	    ...
	    <div id="create" class="w3-modal">
		    <div class="w3-modal-content w3-card-4 w3-animate-top">
		        ...
		        class="w3-button w3-display-topright w3-blue w3-hover-light-blue">&times;</span>
		      	...
		      	<div class="w3-container">
		        	<form method="post" action="<?php echo base_url(); ?>admin/createEvent" class="w3-container">
			         	<div class="w3-section">
			         		<fieldset class="w3-container w3-padding-16 w3-round">
			         			<legend><b>Event Duration</b></legend>
							...
							<fieldset class="w3-container w3-padding-16 w3-round">
								...
								<textarea style="resize: none; width: 100%; height: 150px;" name="description" required></textarea>
							</fieldset>
							
			            	<button class="w3-button w3-block w3-blue w3-section w3-padding w3-round w3-hover-light-blue" type="submit">Create</button>
			          </div>
			        </form>
		      	</div>
