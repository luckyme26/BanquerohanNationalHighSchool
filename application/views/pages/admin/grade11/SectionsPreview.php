 	...
 	<div class="w3-container">
  	...
  	<div class="w3-bar-block">  
	    ...
	    <div id="sections" class="w3-container w3-show">
	    	...
	    	<a href="<?php echo base_url(); ?>admin/grade11/List" onclick="w3_close()" class="w3-bar-item w3-button w3-white w3-text-blue w3-hover-text-blue w3-hover-white w3-padding w3-small w3-margin-left" style="border-radius: 30px 0px 0px 30px;">
	    		<span class="fa fa-users w3-margin-left"></span>&nbsp;&nbsp;Grade 11
	    	</a>
	    	<a href="<?php echo base_url(); ?>admin/grade12/List" class="w3-bar-item w3-button w3-margin-left w3-hover-text-blue w3-hover-white w3-small" style="border-radius: 30px 0px 0px 30px;">
...
<div class="w3-main w3-animate-right w3-margin-bottom" style="margin-left: 245px;">
  	...
  	<div class="w3-container">
	    ...
	    <div class="w3-container w3-card w3-padding w3-round">
	    	...
	    	<a href="<?php echo base_url(); ?>admin/grade11/List" class="w3-small w3-text-blue" style="text-decoration: none;">Sections</a> / <span class="w3-small"><?php echo $section_name; ?></span>
	    	<hr/>
	    	...
	    	<div class="w3-container w3-card w3-padding w3-margin-bottom w3-round">
	    		<?php
	    			$chk = $this->db->query("SELECT * FROM shsstudents WHERE section = '$section_name' AND grade_level = '$grade_level'");
	    			if($chk->num_rows() >= 1){
