 	...
 	<div class="w3-container">
  	...
  	<div class="w3-bar-block">  
	    ...
	    <div id="sections" class="w3-container w3-show">
	    	...
	    	<a href="<?php echo base_url(); ?>admin/grade8/List" onclick="w3_close()" class="w3-bar-item w3-button w3-white w3-text-blue w3-hover-text-blue w3-hover-white w3-padding w3-small w3-margin-left" style="border-radius: 30px 0px 0px 30px;">
...
<div class="w3-main w3-animate-right w3-margin-bottom" style="margin-left: 245px;">
  	...
  	<div class="w3-container">
	    ...
	    <div class="w3-container w3-card w3-padding w3-round">
	    	<h5><b>GRADE 8 SECTIONS</b> - (
	    		<?php
	    			echo "<b>";
	    			echo $this->users_model->getAllgr8();
	    			echo "</b>";
		    			...
		    			<header class="w3-container w3-blue w3-margin-bottom"> 
		      			...
		      			<div class="w3-container w3-padding">
		      				<form action="<?php echo base_url(); ?>admin/createSect" method="post">
					        	...
					        	<input type="hidden" name="grlvl" value="Grade 8">
...
<script type="text/javascript">
    ...
    function LoadAll() {
    	setInterval(function(){
            ...
            notificationitems.open("POST", "https://"+window.location.hostname+"/BanquerohanNationalHighSchool/Admin/notifitems/grade8 List", true);
