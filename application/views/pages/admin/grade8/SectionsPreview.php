...
<div class="w3-main w3-animate-right w3-margin-bottom" style="margin-left: 245px;">
  	...
  	<div class="w3-container">
	    ...
	    <div class="w3-container w3-card w3-padding w3-round">
	    	...
	    	<a href="<?php echo base_url(); ?>admin/grade8/List" class="w3-small w3-text-blue" style="text-decoration: none;">Sections</a> / <span class="w3-small"><?php echo $section_name; ?></span>
	    	<hr/>
