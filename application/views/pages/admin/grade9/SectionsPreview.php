 	...
 	<div class="w3-container">
  	...
  	<div class="w3-bar-block">  
	    ...
	    <div id="sections" class="w3-container w3-show">
	    	...
	    	<a href="<?php echo base_url(); ?>admin/grade9/List" onclick="w3_close()" class="w3-bar-item w3-button w3-white w3-text-blue w3-hover-text-blue w3-hover-white w3-padding w3-small w3-margin-left" style="border-radius: 30px 0px 0px 30px;">
...
<div class="w3-main w3-animate-right w3-margin-bottom" style="margin-left: 245px;">
  	...
  	<div class="w3-container">
	    ...
	    <div class="w3-container w3-card w3-padding w3-round">
	    	...
	    	<a href="<?php echo base_url(); ?>admin/grade9/List" class="w3-small w3-text-blue" style="text-decoration: none;">Sections</a> / <span class="w3-small"><?php echo $section_name; ?></span>
	    	<hr/>
