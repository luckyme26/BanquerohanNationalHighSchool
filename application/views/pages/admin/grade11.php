...
<div class="w3-main w3-animate-right w3-margin-bottom" style="margin-left: 245px;">
  	...
  	<div class="w3-container">
	    ...
	    <div class="w3-container w3-card w3-padding w3-round">
	    	<h6><b>GRADE 11 SECTIONS</b> - (
	    		<?php
	    			echo "<b>";
	    			echo $this->users_model->getAllgr11();
	    			echo "</b>";
		    			...
		    			<header class="w3-container w3-blue w3-margin-bottom"> 
		      			...
		      			<div class="w3-container w3-padding">
		      				<form action="<?php echo base_url(); ?>admin/createSect" method="post">
					        	...
					        	<input type="hidden" name="grlvl" value="Grade 11">
...
<script type="text/javascript">
    ...
    function LoadAll() {
    	setInterval(function(){
            ...
            notificationitems.open("POST", "https://"+window.location.hostname+"/BanquerohanNationalHighSchool/Admin/notifitems/grade11 List", true);
